    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg border border-border bg-background">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-4">
          ...
          {!isEditing && (
            <div className="mb-4 flex gap-2">
              <button
                ...
                className={`rounded-ui-lg px-4 py-2 font-medium transition-colors duration-fast ease-ui ${
          ...
          {isEditing && (
            <div className="rounded-ui-lg border border-border bg-muted/40 p-3">
              ...
              {showProjectSelector && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-ui-lg border border-input bg-background px-3 py-2 text-foreground focus:border-ring focus:ring-ring"
                    required
                  >
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full border px-3 py-2 ${
                  jsonValidationError ? 'border-destructive' : 'border-input'
                } rounded-ui-lg bg-background font-mono text-sm text-foreground focus:border-ring focus:ring-ring`}
                rows={8}
                placeholder={'{\n  "type": "stdio",\n  "command": "npx",\n  "args": ["@upstash/context7-mcp"]\n}'}
                required
              />
              {jsonValidationError && (
                <p className="mt-1 text-xs text-destructive">{jsonValidationError}</p>
              )}
