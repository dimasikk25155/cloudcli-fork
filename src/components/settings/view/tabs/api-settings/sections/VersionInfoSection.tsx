      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">{t('apiKeys.version.tagline')}</p>
          </div>
        </div>

        {/* Юридическая атрибуция апстрима — AGPL-3.0, доп. условия по Section 7
            требуют сохранять её на видном месте и явно помечать сборку как
            изменённую. Убрана только реклама чужого платного хостинга: она к
            атрибуции отношения не имеет, а клиенту предлагала конкурента. */}
