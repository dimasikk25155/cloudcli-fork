...
export default function QuickSettingsHandle({
  ...
  // Цвета — только токены темы. С хардкодом gray/blue язычок оставался белой
  // плашкой поверх любой тёмной темы и первым бросался в глаза на скриншоте.
  ...
  return (
    <button
      ...
      className={`fixed ${placementClass} z-50 ${transitionClass} border border-r-0 bg-card/80 ${borderClass} rounded-l-md p-2 shadow-md backdrop-blur transition-colors hover:bg-accent ${cursorClass} touch-none`}
      style={{
        ...style,
        touchAction: 'none',
